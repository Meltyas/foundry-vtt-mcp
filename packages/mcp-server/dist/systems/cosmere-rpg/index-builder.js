...
export class CosmereRpgIndexBuilder {
    moduleId;
    ...
    async buildIndex(packs, _force = false) {
        ...
        try {
            ...
            console.log(`[${this.moduleId}] Starting Cosmere RPG creature index build from ${actorPacks.length} packs...`);
